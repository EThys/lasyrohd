...
<template>
   ...
   <section class="ji gp uq 2xl:ud-py-35 pg">
        <div class="bb ze ki xn wq">
          <div class="tc wf gg qq">
            ...
            <div class="animate_left xc gn gg jn/2 i">
              <div>
                <img src="../../assets/shape-05.svg" alt="Shape" class="h -ud-left-5 x" />
                <img src="../../assets/about-01.png" alt="About" class="ib" />
                <img src="../../assets/about-02.png" alt="About" />
              </div>
              <div>
                <img src="../../assets/shape-06.svg" alt="Shape" />
                <img src="../../assets/about-03.png" alt="About" class="ob gb" />
                <img src="../../assets/shape-07.svg" alt="Shape" class="bb" />
              </div>
            </div>
            ...
            <div class="animate_right jn/2">
              ...
              <h2 class="text-3xl font-bold text-gray-900 mb-5">
                Lasyrohd is your trusted partner for open and highly available distributed systems analysis.
              </h2> 
              <ul class="space-y-4"> 
                <li class="flex items-start">
                  ...
                  <div class="ml-3">
                    <h3 class="text-xl font-semibold">Unmatched Expertise</h3> 
                    <p class="text-gray-600">Our team of seasoned experts brings years of experience in analyzing complex distributed systems, with a deep understanding of open and highly available architectures.</p>
                  </div> 
                </li> 
              <li class="flex items-start"> 
                <div class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center mt-1"> 
                ...
                <div class="ml-3"> 
                  <h3 class="text-xl font-semibold">Innovative Approach</h3> 
                  <p class="text-gray-600">We employ cutting-edge analysis techniques and continuously develop new methodologies to provide valuable insights into your systems.</p> </div> </li> 
                  <li class="flex items-start"> 
                    <div class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center mt-1">
                      <div class="w-2 h-2 bg-white rounded-full"></div>
                    </div>
                    <div class="ml-3">
                      <h3 class="text-xl font-semibold">Tailored Solutions</h3>
                      <p class="text-gray-600">We offer customized solutions adapted to your specific distributed infrastructure needs, aiming to optimize performance and reliability.</p>
                    </div> 
                  </li> 
                 <li class="flex items-start"> 
                <div class="flex-shrink-0 w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center mt-1">
                 ...
                 <div class="ml-3">
                  <h3 class="text-xl font-semibold">Ongoing Support</h3> 
                  <p class="text-gray-600">Our partnership extends beyond report delivery, offering continuous assistance in implementing recommendations and monitoring system improvements.</p>
                 </div>
                </li>
              </ul> 
              <a href="https://www.youtube.com/watch?v=iOcwpWFzcVU data-fslightbox" class="inline-flex items-center px-6 py-3 mt-6 font-semibold text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition duration-300"> <span class="mr-2"> <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" /> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /> 
                </svg> 
              </span> SEE HOW WE WORK 
            </a> 
            </div>
          </div>
        </div>
    ...
    <!-- <div class="relative isolate overflow-hidden bg-gray-800 sm:py-20">
    <img src="../../assets/team7.jpg" alt="" class="absolute inset-0 bg-black opacity-35 -z-10 size-full object-cover object-right md:object-center">
    <div class="absolute inset-0 bg-black opacity-10 -z-5"></div>
    <div class="hidden sm:absolute sm:-top-10 sm:right-1/2 sm:-z-10 sm:mr-10 sm:block sm:transform-gpu sm:blur-3xl" aria-hidden="true">
      <div class="aspect-[1097/845] w-[68.5625rem] bg-gradient-to-tr from-[#636262] to-[#5aa1ff] opacity-20" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)"></div>
    </div>
      ...
      <div class="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
        ...
        <dl class="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
          <div class="flex flex-col-reverse gap-1">
            <dt class="text-base/7 text-white">Offices worldwide</dt>
            <dd class="text-4xl font-semibold tracking-tight text-white">12</dd>
          </div>
          <div class="flex flex-col-reverse gap-1">
            <dt class="text-base/7 text-white">Full-time colleagues</dt>
            <dd class="text-4xl font-semibold tracking-tight text-white">300+</dd>
          </div>
          <div class="flex flex-col-reverse gap-1">
            <dt class="text-base/7 text-white">Hours per week</dt>
