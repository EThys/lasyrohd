...
<template>
    <section id="support" class="i pg fh rm ji uq">
        <!-- Bg Shapes -->
        <img src="../../assets/shape-06.svg" alt="Shape" class="h aa y" />
        <img src="../../assets/shape-03.svg" alt="Shape" class="h ca u" />
        <img src="../../assets/shape-07.svg" alt="Shape" class="h w da ee" />
        <img src="../../assets/shape-12.svg" alt="Shape" class="h p s" />
        <img src="../../assets/shape-13.svg" alt="Shape" class="h r q" />

        <div
          x-data="{ sectionTitle: ``, sectionTitleText: `It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using.`}"
        >
        ...
        <div class="i va bb ye ki xn wq jb mo">
          <div class="tc uf sn tf rn un zf xl:gap-10">
            <div class="animate_top w-full mn/5 to/3 vk sg hh sm yh rq i pg">
              <!-- Bg Shapes -->
              <img src="../../assets/shape-03.svg" alt="Shape" class="h la x wd" />
              <img src="../../assets/shape-06.svg" alt="Shape" class="h la ma ne kf" />

              <div class="fb">
                <h4 class="wj kk wm cc">Email Address</h4>
                <p><a href="#">Lasyrohd@startup.com</a></p>
              </div>
              <div class="fb">
                <h4 class="wj kk wm cc">Office Location</h4>
                <p>74, Gombe, Kinshasa DRC.</p>
              </div>
              <div class="fb">
                <h4 class="wj kk wm cc">Phone Number</h4>
                <p><a href="#">+243 850 000 021</a></p>
              </div>
              <div class="fb">
