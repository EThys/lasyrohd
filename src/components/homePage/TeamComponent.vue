...
<template>
    ...
    <section class="i pg ji gp uq">
        <!-- Bg Shapes -->
        <span class="rc h s r vd fd/5  rm"></span>
        <img src="../../assets/shape-08.svg" alt="Shape Bg" class="h q r" />
        <img src="../../assets/shape-09.svg" alt="Shape" class="of h y z/2" />
        <img src="../../assets/shape-10.svg" alt="Shape" class="h _ aa" />
        <img src="../../assets/shape-11.svg" alt="Shape" class="of h m ba" />

        <!-- Section Title Start -->
        <div>
          <div class="animate_top bb ze rj ki xn vq">
      <h2 x-text="sectionTitle" class="fk vj pr kk wm on/5 gq/2 bb _b">We Offer The Best Quality Service for You</h2>
    <p class="bb on/5 wo/5 hq" x-text="sectionTitleText">Lorem ipsum dolor sit amet, consectetur adipiscing elit. In convallis tortor eros. Donec vitae tortor lacus. Phasellus aliquam ante in maximus</p>
</div>
          ...
          <div class="wc qf pn xo gg cp">
            ...
            <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="../../assets/team-01.png" alt="Team" />
            ...
            <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="../../assets/team-02.png" alt="Team" />
            ...
            <div class="animate_top rj">
              <div class="c i pg z-1">
                <img class="vd" src="../../assets/team-03.png" alt="Team" />
